...
# df = append
df = pd.read_csv(
    'https://raw.githubusercontent.com/otteheng/Immigrant-Project/master/Graph%201/clean_national_topstates.csv')
...
def outcome_hispanic(state_id):
    dff = df[['year', 'wbhao_igen', 'state', 'Share of 1st Generation', 'Share of 2nd Generation',
              'Share of 3rd Generation']]
